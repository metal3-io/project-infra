...
METAL3BRANCH="${METAL3BRANCH:-use-ubuntu20/furkat}"
CAPM3REPO="${CAPM3REPO:-https://github.com/Nordix/cluster-api-provider-metal3}"
CAPM3BRANCH="${CAPM3BRANCH:-use-ubuntu-2004-e2e/furkat}"
