...
The jenkins configuration is stored in two places. The OpeninfraEurope gerrit instance
...
[OpeninfraEurope Gerrit](https://gerrit.nordix.org/admin/repos/infra/cicd) instance under
...
plugin installed in Jenkins. This is already done by OpeninfraEurope admins. The plugin
